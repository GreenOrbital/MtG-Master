          ...
          content: [
            ...
            },
            {
              ...
              text: [
                ...
                "The card name is the large text at the very top of the card frame.",
                "The card may be in any language (English, German, French, etc.).",
                "Using your knowledge of Magic: The Gathering, identify the card and return its ENGLISH canonical front-face name.",
                "For double-faced cards or split cards, return ONLY the front face name (before any '//' separator).",
                "Return ONLY the English card name — no explanation, no quotes, no punctuation.",
