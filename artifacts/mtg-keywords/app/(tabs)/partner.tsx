...
export default function PartnerScreen() {
  ...
  const recommendHref = `mailto:?subject=${encodeURIComponent(t("Eine App, die deinen Shop interessieren könnte – Master of MtG", "An App That Might Interest Your Store – Master of MtG"))}&body=${encodeURIComponent(t(
    `Hallo,\n\nich nutze die App „Master of MtG" — ein kostenloses Kartenlexikon für Magic: The Gathering-Spieler.\n\nDie App hat ein Partnernetzwerk, über das lokale Spieleläden von Spielern in der Umgebung entdeckt werden können. Das könnte mehr Kunden in deinen Laden bringen.\n\nKontakt: info@greenorbital.de\n\nViele Grüße`,
    `Hi,\n\nI use the app "Master of MtG" — a free card encyclopedia for Magic: The Gathering players.\n\nThe app has a partner network where local game stores can be discovered by nearby players. This could bring more customers to your store.\n\nContact: info@greenorbital.de\n\nBest regards`
  ))}`;
